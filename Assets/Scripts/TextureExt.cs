...
public static class TextureExt {
    ...
    public static void FillPolygon(this Texture2D texture, Vector2[] points, List<Color> color)
    {
        ...
        for (int pixelY = IMAGE_TOP; pixelY <= IMAGE_BOT; pixelY++)
        {
            ...
            for (i = 0; i < nodes; i += 2)
            {
                ...
                if (nodeX[i + 1] > IMAGE_LEFT)
                {
                    ...
                    {
                        Color selectedColor = color[Random.Range(0, color.Count)];
                        texture.SetPixel(j, pixelY, selectedColor);
                    }
                }
            }
        }
